...
const WAY_STRUCTURE: { slug: string; icon: React.ElementType; caps: Cap[]; href: string | null; dashed: boolean; title: string; desc: string; chips: string[]; cta: string }[] = [
  ...
  { slug: "partner",   icon: Handshake,      caps: ["money", "voice"], href: "mailto:safepaws.help@proton.me",      dashed: false, title: "Партнёрство", desc: "Хакспейсы, приюты, частная компания — готовы сотрудничать со всеми.", chips: ["Взаимопомощь", "Сотрудничество"], cta: "Написать →" },
